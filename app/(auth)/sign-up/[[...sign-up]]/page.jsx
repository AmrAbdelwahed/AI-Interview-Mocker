      ...
      <div className="flex min-h-screen">
        ...
        <div className="flex w-full items-center justify-center lg:w-1/2">
          <div className="w-full max-w-md px-8">
            {/* Remove separate logo section since it will be inside the SignUp component */}
            ...
            <SignUp 
              appearance={{
                ...
                elements: {
                  ...
                  logoImage: "w-48 h-32", // Match the same size as sign-in
                ...
                variables: {
                  borderRadius: '0.5rem',
                  colorPrimary: '#4845D2', // Updated to match sign-in page
                  colorText: '#111827',
